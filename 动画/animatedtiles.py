...
if __name__ == '__main__':
    ...
    kineticPix = QPixmap(':/images/kinetic.png')  #跑的这个图片，返回一个QPixmap对象
    bgPix = QPixmap(':/images/Time-For-Lunch-2.jpg')
    scene = QGraphicsScene(-350, -350, 700, 700) #所述QGraphicsScene类提供了一个表面，用于管理大量的2D图形项目。
    #QGraphicsScene没有自己的视觉外观;
    #它只管理物品。您需要创建一个QGraphicsView小部件来可视化场景。
    items = []
    for i in range(64):
    ...
    view.setBackgroundBrush(QBrush(bgPix))#添加背景图片
